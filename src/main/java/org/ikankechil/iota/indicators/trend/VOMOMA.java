 ...
 * <p>
 * ftp://80.240.216.180/Transmission/%D0%A4%D0%B0%D0%B9%D0%BB%D1%8B/S&C%20on%20DVD%2011.26/VOLUMES/V23/C03/059BISS.pdf
 *
 * @author Daniel Kuan
 * @version 0.1
 */
class VOMOMA extends AbstractIndicator {
  ...
  protected RetCode compute(final int start,
    ...
    final double[] vomas = new double[output.length];
    ...
    final double[] momas = new double[vomas.length];
