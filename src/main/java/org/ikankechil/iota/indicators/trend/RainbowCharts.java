/**
 * RainbowCharts.java  v0.5  1 March 2015 5:58:00 pm
 *
 ...
 *
 * <p>References:
 * <li>https://www.forex-tsd.com/attachments/elite-section/108853d1286620402-elite-indicators-mel-widner-rainbow-charts.pdf
 * <li>https://c.mql5.com/forextsd/forum/77/mel_widner_-_rainbow_charts.pdf
 * <li>http://xa.yimg.com/kq/groups/16789226/301268564/name/192verv-1.pdf
...
public class RainbowCharts extends AbstractIndicator {
  ...
  public List<TimeSeries> generate(final TimeSeries series, final int start) {
    ...
    final TimeSeries ma0 = ma.generate(series, start).get(ZERO);
